...
- `FeedSearchAgent` загружает нормализованные товары, делает гибридный поиск и отсекает позиции, не подтверждённые фидом по назначению, температуре, давлению, напору и производительности.
