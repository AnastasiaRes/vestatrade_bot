...
Дата: 2026-08-28T16:06:16.893365+03:00
Маршрут: `http://127.0.0.1:8010/chat` (тот же контракт, что у widget-loader.js)
Сценариев: 10, ходов на режим: 31

## Конфигурация стенда

- health: `{"ok": true, "http_status": 200, "latency_sec": 0.014, "payload": {"status": "ok", "products_loaded": 100, "products_loaded_from": "file", "product_docs_loaded": 24, "llm_provider": "openrouter", "llm_configured": true, "llm_model": "qwen/qwen3-vl-8b-instruct", "llm_request_timeout_seconds": 180.0, "llm_attempt_timeout_seconds": 60.0, "llm_max_retries": 2}}`
- режимы: v2_preview
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| v2_preview | 31/31 | 11 | 1 | 0 | 29 | 2 | 30 | 3/0 | 10.7s / 18.5s |

## Диагностика: v2_preview

- semantic statuses: `{"accepted": 30, "rejected": 1}`
- semantic repairs: `{"capability_constraint_without_turn_evidence_dropped": 2, "constraint_categorical_ambiguity_added": 4, "constraint_closed_value_not_allowed_dropped": 1, "constraint_closed_value_not_grounded_dropped": 3, "constraint_numeric_anchor_unit_recovered": 1, "constraint_numeric_value_not_in_evidence_dropped": 1, "explicit_show_selection_control_recovered": 6, "explicit_sku_constraint_recovered": 1, "explicit_sku_overrode_stale_goal": 1, "explicit_sku_product_scope_recovered": 1, "external_sewer_goal_recovered": 2, "external_sewer_scope_recovered": 1, "generic_show_anchor_forced_continue": 4, "generic_show_rebound_to_active_goal": 4, "information_request_invalid_product_binding_dropped": 1, "shown_card_identifier_unmatched": 1, "spoken_numeric_anchor_recovered": 2, "typed_characteristic_question_rebound_to_active_goal": 1, "typed_numeric_anchor_skipped_model_fact_present": 1, "untyped_ambiguous_selection_strategy_defaulted_to_standard": 9}`
- owners: `{"legacy": 2, "v2": 29}`
- candidate rejection codes: `{"answer_plan_status_unsupported_not_deliverable": 2, "not_all_answer_tasks_have_contracts": 1, "product_contract_resolution_missing": 1}`
- parity: `{"unavailable": 2}`
- LLM completions: 71; cost: $0.131330; prompt/completion tokens: 863865/13591
- diagnostic LLM events: 142; embedding calls: 3; passport events: 15
...
<sub>{"eligible": true, "latency_sec": 4.734, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": ["external_sewer_goal_recovered"], "semantic": "accepted", "v2_action": "ask_decision_changing_question"}</sub>
...
<sub>{"eligible": true, "latency_sec": 8.215, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": ["constraint_closed_value_not_allowed_dropped", "capability_constraint_without_turn_evidence_dropped", "constraint_categorical_ambiguity_added", "external_sewer_goal_recovered", "external_sewer_scope_recovered", "explicit_show_selection_control_recovered"], "semantic": "accepted", "v2_action": "show_preliminary_options"}</sub>
...
<sub>{"eligible": true, "latency_sec": 6.145, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": [], "semantic": "accepted", "v2_action": "compare"}</sub>
...
<sub>{"eligible": true, "latency_sec": 8.584, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": ["spoken_numeric_anchor_recovered"], "semantic": "accepted", "v2_action": "ask_decision_changing_question"}</sub>
...
<sub>{"eligible": true, "latency_sec": 6.213, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": ["generic_show_rebound_to_active_goal", "explicit_show_selection_control_recovered", "generic_show_anchor_forced_continue"], "semantic": "accepted", "v2_action": "show_preliminary_options"}</sub>
...
<sub>{"eligible": true, "latency_sec": 10.12, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": ["untyped_ambiguous_selection_strategy_defaulted_to_standard"], "semantic": "accepted", "v2_action": "compare"}</sub>
...
Уточняемая характеристика: двадцать.
...
<sub>{"eligible": true, "latency_sec": 24.594, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": [], "semantic": "accepted", "v2_action": "recommend_one"}</sub>
...
«Кран шаровой BASE, стальная рукоятка 1/2" вн.-вн.» (артикул VT.214.N.04) — дополнительный точный вариант: цена — 503 руб.; остаток по фиду — 2 (единица складского учёта в фиде не указана); наличие — в наличии; размер присоединения — 1/2; тип резьбового соединения — внутренняя/внутренняя резьба; ссылка — https://www.vestatrade.ru/vodozapornaya-armatura-2/krany-sharovye/krany-sharovye-valtec-base/kran-shar-base-stalnaya-rukoyatka-12-vn-vn/.
«Кран шаровой BASE с дренажом и воздухоотводчиком 1/2" вн.-вн.» (артикул VT.245.N.04) — дополнительный точный вариант: цена — 753 руб.; остаток по фиду — 0 (единица складского учёта в фиде не указана); наличие — нет в наличии; размер присоединения — 1/2; тип резьбового соединения — внутренняя/внутренняя резьба; ссылка — https://www.vestatrade.ru/vodozapornaya-armatura-2/krany-sharovye/krany-sharovye-valtec-base/kran-shar-base-s-drenazhom-i-vozduhootvodchikom-12-vn-vn/.
Для параметра «уточняемая характеристика» нет подтверждённого правила, которое объясняет его влияние на выбор. Я не буду придумывать инженерную причину.

<sub>товары: VT.217.N.04 Кран шаровой BASE, рукоятка бабочка 1/2" вн.-вн. — 452.0 RUB; VT.214.N.04 Кран шаровой BASE, стальная рукоятка 1/2" вн.-вн. — 503.0 RUB; VT.245.N.04 Кран шаровой BASE с дренажом и воздухоотводчиком 1/2" вн.-вн. — 753.0 RUB</sub>

<sub>{"eligible": true, "latency_sec": 13.095, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": ["shown_card_identifier_unmatched", "untyped_ambiguous_selection_strategy_defaulted_to_standard"], "semantic": "accepted", "v2_action": "explain_term_or_method"}</sub>
...
<sub>{"eligible": true, "latency_sec": 10.107, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": [], "semantic": "accepted", "v2_action": "calculate_preliminary"}</sub>
...
<sub>{"eligible": true, "latency_sec": 12.874, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": ["constraint_closed_value_not_grounded_dropped", "constraint_categorical_ambiguity_added"], "semantic": "accepted", "v2_action": "ask_decision_changing_question"}</sub>
...
<sub>{"eligible": true, "latency_sec": 7.729, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": [], "semantic": "accepted", "v2_action": "explain_term_or_method"}</sub>
...
<sub>{"eligible": true, "latency_sec": 13.972, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": ["generic_show_rebound_to_active_goal", "capability_constraint_without_turn_evidence_dropped", "explicit_show_selection_control_recovered", "generic_show_anchor_forced_continue"], "semantic": "accepted", "v2_action": "show_preliminary_options"}</sub>
...
<sub>{"eligible": true, "latency_sec": 16.169, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": ["generic_show_rebound_to_active_goal", "explicit_show_selection_control_recovered", "generic_show_anchor_forced_continue"], "semantic": "accepted", "v2_action": "show_preliminary_options"}</sub>
...
<sub>{"eligible": true, "latency_sec": 10.538, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": [], "semantic": "accepted", "v2_action": "compare"}</sub>
...
<sub>{"eligible": true, "latency_sec": 10.595, "owner": "v2", "passport_events": 4, "rejections": [], "repairs": ["typed_characteristic_question_rebound_to_active_goal", "untyped_ambiguous_selection_strategy_defaulted_to_standard"], "semantic": "accepted", "v2_action": "answer_direct_question"}</sub>
...
<sub>{"eligible": true, "latency_sec": 18.512, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": ["constraint_closed_value_not_grounded_dropped", "constraint_categorical_ambiguity_added"], "semantic": "accepted", "v2_action": "ask_decision_changing_question"}</sub>
...
<sub>{"eligible": true, "latency_sec": 9.582, "owner": "v2", "passport_events": 1, "rejections": [], "repairs": ["untyped_ambiguous_selection_strategy_defaulted_to_standard"], "semantic": "accepted", "v2_action": "explain_term_or_method"}</sub>
...
<sub>{"eligible": true, "latency_sec": 6.393, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": ["untyped_ambiguous_selection_strategy_defaulted_to_standard"], "semantic": "accepted", "v2_action": "continue_with_confirmed_facts"}</sub>
...
<sub>{"eligible": true, "latency_sec": 8.094, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": [], "semantic": "accepted", "v2_action": "ask_decision_changing_question"}</sub>
...
<sub>{"eligible": true, "latency_sec": 7.253, "owner": "v2", "passport_events": 1, "rejections": [], "repairs": ["information_request_invalid_product_binding_dropped", "untyped_ambiguous_selection_strategy_defaulted_to_standard"], "semantic": "accepted", "v2_action": "wait_for_semantic_understanding"}</sub>
...
<sub>{"eligible": true, "latency_sec": 7.052, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": [], "semantic": "accepted", "v2_action": "ask_decision_changing_question"}</sub>
...
<sub>{"eligible": true, "latency_sec": 9.215, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": ["typed_numeric_anchor_skipped_model_fact_present"], "semantic": "accepted", "v2_action": "ask_decision_changing_question"}</sub>
...
<sub>{"eligible": true, "latency_sec": 8.177, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": [], "semantic": "accepted", "v2_action": "ask_decision_changing_question"}</sub>
...
<sub>{"eligible": true, "latency_sec": 11.423, "owner": "v2", "passport_events": 0, "rejections": [], "repairs": ["explicit_show_selection_control_recovered"], "semantic": "accepted", "v2_action": "show_preliminary_options"}</sub>
...
<sub>{"eligible": true, "latency_sec": 11.453, "owner": "v2", "passport_events": 4, "rejections": [], "repairs": [], "semantic": "rejected", "v2_action": "wait_for_semantic_understanding"}</sub>
...
<sub>{"eligible": true, "latency_sec": 8.467, "owner": "v2", "passport_events": 4, "rejections": [], "repairs": [], "semantic": "accepted", "v2_action": "answer_direct_question"}</sub>

**П:** Сравните её с PP-ALUX

**Б:** Труба для чего: для холодной или горячей воды, для отопления или для канализации? Уточните участок системы и диаметр; если диаметр нужно рассчитать — расход и длину трассы.

<sub>{"eligible": false, "latency_sec": 22.867, "owner": "legacy", "passport_events": 0, "rejections": ["answer_plan_status_unsupported_not_deliverable"], "repairs": ["untyped_ambiguous_selection_strategy_defaulted_to_standard"], "semantic": "accepted", "v2_action": "compare"}</sub>
