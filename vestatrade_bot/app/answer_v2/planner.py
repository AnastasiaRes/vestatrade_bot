...
def _next_step(action: NextAction) -> NextStepKind:
    mapping = {
        ...
        NextActionKind.CHECK_COMPATIBILITY: NextStepKind.STATE_COMPATIBILITY_BOUNDARY,
        NextActionKind.CALCULATE_PRELIMINARY: NextStepKind.CALCULATE_CATALOGUE_AMOUNT,
